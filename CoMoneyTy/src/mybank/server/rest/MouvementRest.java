...
public class MouvementRest {
    ...
    static String ENTITY = "mouvement";
    ...
    public Response getListe(@Context HttpHeaders headers, @Context UriInfo uriInfo, byte[] data) {
        ...
        try {
            ...
            List<Mouvement> liste = (List<Mouvement>)Accesseur.getListeFiltre(Mouvement.class, clauseWhere);
    ...
    public Response create(@Context HttpHeaders headers, @Context UriInfo uriInfo) {
        ...
        try {
            // Vérification de l'accès depuis un user connecté
            connexionUser = ConnexionUser.verificationConnexionUser(headers);
            Mouvement aMouvement = new Mouvement();
    ...
    public Response save(@Context HttpHeaders headers, @Context UriInfo uriInfo, byte[] data) {
        ...
        try {
            ...
            aMessage.setContactEmetteur(aMouvement.getEmetteur());
            aMessage.setContactDestinataire(aMouvement.getDestinataire());
            aMessage.setLu(false);
            aMessage.setMessage("Message automatique lié à la sauvegarde d'un mouvement....");
