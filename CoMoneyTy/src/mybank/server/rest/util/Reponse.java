...
public class Reponse {
    ...
    public static Response reponseKO(Exception e) {
        ...
        if (message == null) {
            message = "Erreur technique du serveur REST : null sur " + e.getStackTrace()[0].getClassName().toString() + " (Ligne:" + e.getStackTrace()[0].getLineNumber() + ")";
        }
